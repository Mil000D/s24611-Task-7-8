...
public class Money implements Comparable {
	...
	public String toString() {
		return String.format(Locale.US, "%.2f %s", amount / 100.0, currency.getName());
	}
	...
	// I've overridden this method to make it easier to test assertions in AccountTest
	@Override
	public boolean equals(Object otherMoney) {
		if(otherMoney instanceof Money) {
			return this.universalValue().equals(((Money) otherMoney).universalValue());
		}
        return false;
    }
	/**
