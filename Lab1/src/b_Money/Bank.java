...
public class Bank {
	...
	// I had to create this method
	// to check if account was opened correctly in testOpenAccount().
	...
	public void openAccount(String accountid) throws AccountExistsException {
		if (accountlist.containsKey(accountid)) {
			...
			// Had to change the code because of the error in testOpenAccount()
			// from accountlist.get(accountid); to the code snippet below
	...
	public void deposit(String accountid, Money money) throws AccountDoesNotExistException {
		// Here I had to change if statement to negation, because of java.lang.NullPointerException
		// in testAddRemoveTimedPayment() test, from
		// if (accountlist.containsKey(accountid)) to :
	...
	public void withdraw(String accountid, Money money) throws AccountDoesNotExistException {
		if (!accountlist.containsKey(accountid)) {
			...
			Account account = accountlist.get(accountid);
			// I've found this bug while testing testWithdraw() test case,
			// previously it was account.deposit(money) and it was changed to the code below :
	...
	public void transfer(String fromaccount, String toaccount, Money amount) throws AccountDoesNotExistException {
		// Here was a bug method was using variable fromaccount 2 times like this
